...
<HTML>
<HEAD><TITLE>View all open courses for Registration</TITLE></HEAD>

<%@ include file="header.jsp" %>


<H1 ALIGN="CENTER">View all open courses for Registration</H1>
<center>
...
//	List<Object[]> records =dm.getAllOpenClasses(studentID);
	List<Object[]> records = (List<Object[]>)session.getAttribute("OpenClassesList");
	if(records==null) {
    ...
    if(startPos>0 ||  nextPos<records.size()){
		...
		// 	out.println("<td><a href=\"/JKnightGenericView-DB/FrontController?StartPosition="+
		// 		prevPos+"\">&lt;&lt;Prev</a></td>");
		 	out.println("<td><a href=\"/JKnightGenericView-DB/RegisterClassServlet?StartPosition="+
		 		prevPos+"\">&lt;&lt;Prev</a></td>");
...
final static Link[] links = new Link[] { new Link(null, "/JKnightGenericView-DB/Review?", 1),
				new Link("Register", "/JKnightGenericView-DB/RegisterForThisCourse?", -1) };
